...
//    
   ...
   //
    ...
    public function BuscarUno($idAlumno) {
        ...
        $apellidos=$this-> M_AtDiversidad->getUnApellido($idAlumno);
...
//------------------------------------------ FIN BUSQUEDA CURSO --------------------------------------------------          
    ...
    public function getConfigPag($apellidos){
        ...
        $config['base_url'] = site_url('/AtDiversidad/Buscar');
    ...
    public function buscarApellidos(){
        $array = array();
        $apellidos = $this->input->post('apellidos');
        
        $alumnos = $this->M_Alumno->getApellidosUsuario($apellidos,10, 0,'apellidos');
        print_r(json_encode($alumnos));
    }
