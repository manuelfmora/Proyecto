...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-12-2016 a las 19:07:53
...
(10, 'Mora Perez', 'Manuel', 12125, '1970-12-28', NULL, NULL, 'Ninguno', 'Nimguno', 'Sin insidencias', 'Manuel Mora', 'Inmaculada Ramos', 'Avda. Andalucia nº 85 2º', 21500, 'Gigraleón', '21', 959301125, 607535988, 'Monoparental', 'Estable', 'Estable', 2, 'B', NULL, 1),
(11, 'Ramos Bebia', 'Inmaculada', 54321, '1971-12-25', NULL, NULL, 'Ninguno', 'Ninguno', 'Aceptado', 'Luis Ramos', 'Antónia Bebia', 'Avda. Andalucia nº 85 2º', 21500, 'Gigraleón', '21', 959301125, 607535544, 'Normal', 'Normal', 'Normal', 3, 'C', NULL, 1),
(12, 'Mora Martin', 'Manuel Francisco', 12124, '1970-12-28', NULL, NULL, 'Otros', 'Ninguno', 'Ninguno', 'Inmaculada ', 'Pepe', 'Avda. Andalucía Nº85 2º', 21500, 'Gibraleón', '18', 959301156, 959301156, 'Ninguno', 'Ninguno', 'Ninguno', 2, 'B', NULL, 1),
(13, 'Martín Rodriguez', 'Alicia', 11111, '1970-12-28', NULL, NULL, 'n', 'n', 'n', 'Manuel Francisco', 'Manuel Francisco', 'Avda. Andalucía Nº85 2º', 21500, 'Gibraleón', '18', 959301156, 959301156, 'ghjgh', 'ghjg', 'ghjg', 1, 'A', NULL, 1),
(14, 'Perez', 'Alejandro', 22222, '1970-12-28', NULL, NULL, 'Ninguno', 'Ninguno', 'Ninguno', 'Manuel Francisco', 'Manuel Francisco', 'Avda. Andalucía Nº85 2º', 21500, 'Gibraleón', '03', 959301156, 959301156, 'Ninguno', 'Ninguno', 'Ninguno', 2, 'B', NULL, 1),
(15, 'Ramos Bebia', 'Inmaculada', 44444, '1970-12-28', NULL, NULL, 'Ninguno', 'Ninguno', 'Ninguno', 'Pepe', 'Pepe', 'Avda. Andalucía Nº25', 21500, 'Gibraleón', '11', 959302254, 959302254, 'Ninguno', 'Ninguno', 'Ninguno', 3, 'A', NULL, 1),
(18, 'AS', 'AS3', 0, '0000-00-00', NULL, NULL, NULL, NULL, NULL, '', NULL, '', 0, '', NULL, 0, NULL, NULL, NULL, NULL, 0, '', NULL, 1),
(19, 'Mora Martin', 'Manuel', 11221, '1970-12-28', NULL, NULL, 'sdfdgsd', 'sdfgsdfg', 'sdfhnryyjh', 'Manuel Mora', 'Manule', 'Avda. Andalucia nº 85 2º', 21500, 'Gigraleón', '17', 959301125, 959301156, 'sdfhghfh', 'sfhjryj', 'yeyjetytej', 2, 'B', NULL, 1),
(20, 'Mora Perez', 'Manuel', 12123, '1970-12-28', NULL, NULL, 'dsafds', 'asdfdsf', 'asdfasf', 'Manuel Mora', 'Inmaculada Ramos', 'Avda. Andalucia nº 85 2º', 21500, 'Gigraleón', '05', 959301125, 959301156, 'dfgnsdjesj', 'setyjseytej', 'etyjytejyj', 2, 'B', '2016-12-15', 1);
...
--
-- Volcado de datos para la tabla `consejo_orientador`
--

INSERT INTO `consejo_orientador` (`idConsejo_Orientador`, `opciones`, `fecha`, `idAlumno`) VALUES
(1, 'F.P.B.', '1970-12-18', 12),
(2, 'Mat. Académicas', '1970-12-28', 10);
...
(1, '1970-12-20', 'OTROS', 'tutor,otros', 'OTROS', 'OTROS', 12);
...
(13, 'apoyo educativo,ACI', '1970-12-28', '1970-12-30', 'Prueba de modificación', 12);
...
(5, 'DIS', 'ukfy', 'fukf', 14),
(6, 'DIS,Compensatoria', 'Evaluación', 'Dictamen', 12);
...
(1, 'ident', '1970-12-29', '1970-12-30', 'Prueba Modificar ok', 12);
...
(3, 'otros', 0, 'otros', 'otros', 'otros', 12);
...
(2, '2017/2018', 'Segunda Evaluación', '1970-12-28', 'otros', 'otros', 'si', 'no', 'otros', 'otros', 'otros', 12);
...
(1, 'admin', 'Manuel Francisco', 'Martín', 'mfmora2@gmail.com', 'A', '29056491Q', '$2y$10$1X6TzcSDWdFjMjjYmbtFX.Qgb172x/srmtefdvtExZA8nU1zXykvC'),
(2, 'user', 'Manuel', 'Martín', 'mfmora2@gmail.com', 'A', '29056491Q', '$2y$10$t/wOnKicBp/SIo3tlMcJWOFQd0s9mHLXJuu2Tjrx/wU0EtpZaC.RC'),
(3, 'Prueba', 'Prueba', 'Prueba', 'mfmoraftp@gmail.com', 'A', '29056491Q', '$2y$10$6OWyZmKLvR2lINxAXu4P6e82/93PYMvsaYvP1gB/lTeCDoIau2jMS'),
(4, 'Prueba disparador', 'Manuel Francisco', 'Martín', 'mfmora2@gmail.com', 'A', '29056491Q', '$2y$10$54Iz.L4Vle2wm3zNpwK5w.CWPkuME1siCf7qmCHs3N8nYpC0Av8RK'),
(5, 'PRUEBADISPARADOR2', 'Manuel Francisco', 'Martín', 'mfmora2@gmail.com', 'B', '29056491Q', '$2y$10$QQqn2XwosZaYs63/HC91xuhhKTBH7kT1/qcWhnAcAnTxlhYAwwwtK'),
(6, 'P5', 'Manuel Francisco', 'Martín', 'mfmora2@gmail.com', 'B', '29056491Q', '$2y$10$FCd0.I2S6EGYNOUvMGn.oem7pRPkaEhdVX0w7URppQN2FUi5urugC'),
(7, 'PCorreo', 'Manuel Francisco', 'Martín', 'mfmora2@gmail.com', 'B', '29056491Q', '$2y$10$UBDkOugckP//0t1DPzxLxOqWTdEfDAlsVpmDWQPNl15irX3inifSK');
...
--
ALTER TABLE `neae`
  MODIFY `idNeae` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Necesidades Especiales Apoyo Educativo', AUTO_INCREMENT=7;
--
